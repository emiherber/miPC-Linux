import{_ as s,c as a,o as n,a as l}from"./app.d825676a.js";const u=JSON.parse('{"title":"Crear virtual host","description":"","frontmatter":{},"headers":[],"relativePath":"php/virtualhost.md"}'),e={name:"php/virtualhost.md"},o=l(`<h1 id="crear-virtual-host" tabindex="-1">Crear virtual host <a class="header-anchor" href="#crear-virtual-host" aria-hidden="true">#</a></h1><p>Para crear un virtual host se debe agregar en el siguiente archivo <strong>000-default.conf</strong></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">nano /etc/apache2/sites-available/000-default.conf</span></span>
...
<span class="line"><span style="color:#A6ACCD;">&lt;/VirtualHost&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>Para acceder al sitio definido en el virtual host se debe registrar el <strong>serverName</strong> en el archivo /etc/hosts.</p><table><thead><tr><th>Ip localhost</th><th style="text-align:center;">serverName</th></tr></thead><tbody><tr><td>127.0.0.1</td><td style="text-align:center;">nombreProyecto.local</td></tr></tbody></table>`,8),t=[o];function p(r,c,i,C,A,d){return n(),a("div",null,t)}const h=s(e,[["render",p]]);export{u as __pageData,h as default};
