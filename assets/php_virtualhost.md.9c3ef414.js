import{_ as s,c as a,o as n,a as l}from"./app.e009cd84.js";const y=JSON.parse('{"title":"Crear virtual host","description":"","frontmatter":{},"headers":[],"relativePath":"php/virtualhost.md"}'),e={name:"php/virtualhost.md"},o=l(`<h1 id="crear-virtual-host" tabindex="-1">Crear virtual host <a class="header-anchor" href="#crear-virtual-host" aria-hidden="true">#</a></h1><p>Para crear un virtual host se debe agregar en el siguiente archivo <strong>000-default.conf</strong></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">nano /etc/apache2/sites-available/000-default.conf</span></span>
...
<span class="line"><span style="color:#A6ACCD;">&lt;/VirtualHost&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>Para acceder al sitio definido en el virtual host se debe registrar el <strong>serverName</strong> en el archivo /etc/hosts.</p><blockquote><p>Ip localhost serverName 127.0.0.1 sistgestioncpeceer.local</p></blockquote>`,8),p=[o];function t(r,c,i,C,A,u){return n(),a("div",null,p)}const h=s(e,[["render",t]]);export{y as __pageData,h as default};
