import{_ as s,c as a,o as n,a as p}from"./app.d825676a.js";const m=JSON.parse('{"title":"Terminal","description":"","frontmatter":{},"headers":[],"relativePath":"ubuntu/terminal.md"}'),e={name:"ubuntu/terminal.md"},l=p(`<h1 id="terminal" tabindex="-1">Terminal <a class="header-anchor" href="#terminal" aria-hidden="true">#</a></h1><p>Personalizo la terminal con ohmybash/oh-my-bash <a href="https://github.com/ohmybash/oh-my-bash" target="_blank" rel="noreferrer">oh-my-bash</a></p><p>Instalo el tema powerline <a href="https://github.com/ohmybash/oh-my-bash/tree/master/themes/powerline" target="_blank" rel="noreferrer">Powerline Theme</a></p><p>Cargar los alias del archivo .bash_aliases en ohmybash if [ -f ~/.bash_aliases ]; then . ~/.bash_aliases fi</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;"># iniciar/parar docker para php73 + sqlserver</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,5),o=[l];function r(t,c,i,C,A,h){return n(),a("div",null,o)}const _=s(e,[["render",r]]);export{m as __pageData,_ as default};
