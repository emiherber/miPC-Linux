import{_ as s,c as a,o as n,d as l}from"./app.ea871410.js";const d=JSON.parse('{"title":"Crear virtual host","description":"","frontmatter":{},"headers":[],"relativePath":"php/virtualhost.md"}'),e={name:"php/virtualhost.md"},o=l(`<h1 id="crear-virtual-host" tabindex="-1">Crear virtual host <a class="header-anchor" href="#crear-virtual-host" aria-hidden="true">#</a></h1><p>Para crear un virtual host se debe agregar en el siguiente archivo <strong>000-default.conf</strong></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">nano /etc/apache2/sites-available/000-default.conf</span></span>
