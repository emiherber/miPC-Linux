...
<span class="line"><span style="color:#A6ACCD;">&lt;/VirtualHost&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>Para acceder al sitio definido en el virtual host se debe registrar el <strong>serverName</strong> en el archivo /etc/hosts. Ip localhost serverName 127.0.0.1 sistgestioncpeceer.local</p>`,7),p=[o];function t(r,c,i,C,A,d){return n(),a("div",null,p)}const h=s(e,[["render",t]]);export{y as __pageData,h as default};
